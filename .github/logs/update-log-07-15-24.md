### Generated logs from GitHub Action: [9934585645](https://github.com/moadz/multicluster-observability-operator/actions/runs/9934585645)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240713063519-bdf5b22ef068
...
- go: github.com/openshift/hypershift/api@v0.0.0-20240713063519-bdf5b22ef068 requires go >= 1.22.0; switching to go1.22.5
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240713063519-bdf5b22ef068), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240713063519-bdf5b22ef068), but does not contain package github.com/openshift/hypershift/api/v1beta1
